...
MobileROS integrates radio-awareness directly into the robotics runtime. The repository now uses the unified `mobile_ros` namespace; the legacy `wireless_ros` shim remains for backwards compatibility but is **deprecated** and will be removed in a future release.
